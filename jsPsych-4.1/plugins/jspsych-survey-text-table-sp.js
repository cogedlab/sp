...
(function($) {
    jsPsych['survey-text-table-sp'] = (function() {
        ...
        plugin.trial = function(display_element, trial) {
            ...
            for (var i = 0; i < trial.questions.length; i++) {
                ...
                display_element.append($('<div>', {
                    "id": 'jspsych-survey-text-table-sp-' + i,
                    "class": 'jspsych-survey-text-table-sp-question'
                }));

                // add question text and input text box
                $("#jspsych-survey-text-table-sp-" + i).append('<table><tr><td class="stimulus" width=800 height=15>' + trial.questions[i] + '</td><td class="text-response"><input type="text" name="#jspsych-survey-text-table-sp-response-' + i + '"></input></td></tr>');
